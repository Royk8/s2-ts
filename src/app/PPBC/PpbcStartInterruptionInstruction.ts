...
interface ConstructorParameters {
    ...
    power_profile_id: ID;
    /**
     * ID of the PPBC.PowerSequenceContainer of which the PPBC.PowerSequence is being interrupted by the CEM.
     */
...
export class PpbcStartInterruptionInstruction implements PPBC_StartInterruptionInstruction, S2Message {
    ...
    /**
     * Constructs a new instance of the PpbcStartInterruptionInstruction class.
     * 
     ...
     * @param {Timestamp} parameters.execution_time - Indicates the moment the PPBC.PowerSequence shall be interrupted.
